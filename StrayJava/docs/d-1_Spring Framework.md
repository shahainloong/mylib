...
官网：https://docs.spring.io/

文档说明：

- spring-4.3.27: https://docs.spring.io/spring/docs/4.3.27.RELEASE/spring-framework-reference/htmlsingle/
- spring-5.2.6: https://docs.spring.io/spring/docs/5.2.6.RELEASE/spring-framework-reference/

### 1. 常用类及注解

#### 1.1 RestTemplate

> 参考：https://docs.spring.io/spring/docs/4.3.27.RELEASE/spring-framework-reference/htmlsingle/#rest-resttemplate
