 ...
 * CGLIB 通过继承方式实现代理。
 * <p>
 * 很多知名的开源框架都使用到了[CGLIB](https://github.com/cglib/cglib)， 例如 Spring 中的 AOP 模块中.</p>
 ...
 * 3. 通过{@link net.sf.cglib.proxy.Enhancer Enhancer}类的{@link Enhancer#create() create()}创建代理类；
 * </pre>
 *
