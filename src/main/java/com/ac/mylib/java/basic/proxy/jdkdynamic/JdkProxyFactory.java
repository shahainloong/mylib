 ...
 * <ol><li>
 * 定义一个接口及其实现类；</li><li>
 * 自定义{@link InvocationHandler InvocationHandler}并重写{@link InvocationHandler#invoke invoke}方法，在{@link InvocationHandler#invoke invoke}方法中我们会调用原生方法（被代理类的方法）并自定义一些处理逻辑；</li><li>
 * 通过{@link Proxy#newProxyInstance newProxyInstance}方法创建代理对象；
 * </li></ol>
