...
public class MyQueue {
	...
	public static void main(String[] args) {
		...
		namesArrayDeque.add(NAME_AMY);
		namesArrayDeque.add(NAME_BOB);
		namesArrayDeque.add(NAME_CLERA);
		namesArrayDeque.add(NAME_DOCK);
		namesArrayDeque.add(NAME_ELLE);
		...
		namesLinkedList.add(NAME_AMY);
		namesLinkedList.add(NAME_BOB);
		namesLinkedList.add(NAME_CLERA);
		namesLinkedList.add(NAME_DOCK);
		namesLinkedList.add(NAME_ELLE);
